...
export class AdminUpdate {
  ...
  @Hears("Xizmatlar")
  async onCommandXizmatlar(@Ctx() ctx: Context) {
    await this.adminService.onCommandXizmatlar(ctx);
  }

  @Action(/jobtypeToAdmin_+\d+/)
  async onClickJobType(@Ctx() ctx: Context) {
    await this.adminService.onClickJobType(ctx);
  }

  @Action(/deleteJobtype_+\d+/)
  async onClickDeleteJobtype(@Ctx() ctx: Context) {
    await this.adminService.onClickDeleteJobtype(ctx);
  }
